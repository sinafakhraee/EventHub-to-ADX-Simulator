...
namespace SendSampleData
{
    class Program
    {
        ...
        const string connectionString = @"Endpoint=sb://eventhubnamespace.servicebus.windows.net/;SharedAccessKeyName=******************";
                ...
                for (int i = 0; i < 100; i++)
                {
                    ...
                    try
                    {
                        var records = Enumerable
                            ...
                            .Select(recordNumber => $"{{\"vehicleID\":3,   \"timestamp\": \"{DateTime.UtcNow.AddSeconds(100 * counter)}\",\"source\": \"EventHubMessage\" }}");
                        ...
                        eventData.Properties.Add("Table", "BDTable");
                        eventData.Properties.Add("IngestionMappingReference", "Mapping");
